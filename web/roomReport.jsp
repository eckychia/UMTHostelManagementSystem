<%-- 
    Document   : roomReport
    Created on : Jun 15, 2023, 7:55:45 PM
    Author     : admin
--%>
                    ...
                    <div class="row" style="background-color:white; color:black;">
                        <div class="col-md-12">
                            <div class="section-header text-center pb-5">
                                ...
                                <h1 style="font-family: 'Rowdies'; color: black;">ROOM REPORT</h1>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    <div class="img-area mb-4">
                                        <br><img src="images/room.png" style="width:200px; height:200px;">
                                    </div>
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">Room</h3><br>
                                    Total Room: <%=request.getAttribute("roomNumber")%>
                                </div><br>
                            </div>
                        </div>
