<%-- 
    Document   : applicationReport
    Created on : Jun 16, 2023, 12:18:58 AM
    Author     : admin
--%>
                        ...
                        <div class="row" style="background-color:white; color:black;">
                            <div class="col-md-12">
                                <div class="section-header text-center pb-5">
                                    ...
                                    <h1 style="font-family: 'Rowdies'; color: black;">APPLICATION REPORT</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="background-color:white; color:black;">
                                ...
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        <div class="img-area mb-4">
                                            <br><img src="images/hostel.png" style="width:200px; height:200px;">
                                        </div>
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">HOSTEL APPLICATION</h3><br>
                                        Total Hostel Application: <%=request.getAttribute("totalHostelApplication")%>
                                    </div><br>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        <div class="img-area mb-4">
                                            <br><img src="https://cdn-icons-png.flaticon.com/512/310/310990.png" style="width:200px; height:200px;">
                                        </div>
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">SUCCESSFUL APPLICATION</h3><br>
                                        Successful Application: <%=request.getAttribute("totalRoomApplication")%>
                                    </div><br>
                                </div>
                            </div>
