<%-- 
    Document   : staffRoomPage
    Created on : 7 Jun 2023, 11:17:45 pm
    Author     : User
--%>
            ...
            <div class="row" style="background-color:white; color:black;">
                <div class="col-md-12">
                    <div class="section-header text-center pb-5">
                        <br><br>
                        <h1 style="font-family: 'Rowdies'; color: black;">ROOM</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <%if (session.getAttribute("user").equals("admin")) { %>
                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Add a New Room <br><br><br>
                                <a href="http://localhost:8080/UMTHostelManagementSystem/newRoom"><button class="btn mt-3" style="color: white; background-color: orange;">Add</button></a>
                            <%} else { %>
                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Add a New Room<br><span style="color:red; font-weight: 420;">*Only Admin is Allowed to Add</span><br><br>
                                <a href="http://localhost:8080/UMTHostelManagementSystem/newRoom"><button class="btn mt-3" style="color: white; background-color: orange;" disabled="true">Add</button></a>
                            <%}%>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Edit an Existing Room<br><br><br>
                                <a href="http://localhost:8080/UMTHostelManagementSystem/roomList"><button class="btn mt-3" style="color: white; background-color: orange;">Edit</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Get the List of Room <br><br><br>
                                <a href="http://localhost:8080/UMTHostelManagementSystem/roomList"><button class="btn mt-3" style="color: white; background-color: orange;">Get List</button></a>
                        </div>
                    </div>
                </div>
            </div>
