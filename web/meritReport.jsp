<%-- 
    Document   : meritReport
    Created on : Jun 15, 2023, 9:05:56 PM
    Author     : admin
--%>
                        ...
                        <div class="row" style="background-color:white; color:black;">
                            <div class="col-md-12">
                                <div class="section-header text-center pb-5">
                                    ...
                                    <h1 style="font-family: 'Rowdies'; color: black;">MERIT REPORT</h1>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        <div class="img-area mb-4">
                                            <br><img src="images/merit.png" style="width:200px; height:200px;">
                                        </div>
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">Highest Merit</h3><br>
                                        Highest Merit: <%=request.getAttribute("maxMerit")%>
                                    </div><br>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12 ">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">Lowest Merit</h3><br>
                                        Lowest Merit: <%=request.getAttribute("minMerit")%>
                                    </div><br>
                                </div>
                            </div>       
                        </div>
