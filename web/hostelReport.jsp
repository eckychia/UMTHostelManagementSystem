<%-- 
    Document   : hostelReport
    Created on : Jun 15, 2023, 3:31:04 PM
    Author     : admin
--%>
                    ...
                    <div class="row" style="background-color:white; color:black;">
                        <div class="col-md-12">
                            <div class="section-header text-center pb-5">
                                ...
                                <h1 style="font-family: 'Rowdies'; color: black;">HOSTELS REPORT</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    Total Hostel: <%=request.getAttribute("hostelNumber")%>
                                </div><br>
                            </div>
                        </div>
