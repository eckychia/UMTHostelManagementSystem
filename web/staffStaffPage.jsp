<%-- 
    Document   : staffStaffPage
    Created on : 9 Jun 2023, 9:46:49 PM
    Author     : wongh
--%>
                    ...
                    <div class="row" style="background-color:white; color:black;">
                        <div class="col-md-12">
                            <div class="section-header text-center pb-5">
                                <br><br>
                                <h1 style="font-family: 'Rowdies'; color: black;">STAFF</h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Add a New Staff<br><br><br>
                                        <a href="http://localhost:8080/UMTHostelManagementSystem/newStaff"><button class="btn mt-3" style="color: white; background-color: orange;">Add</button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Edit an Existing Staff<br><br><br>
                                        <a href="http://localhost:8080/UMTHostelManagementSystem/staffList"><button class="btn mt-3" style="color: white; background-color: orange;">Edit</button></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Get the List of Staffs<br><br><br>
                                        <a href="http://localhost:8080/UMTHostelManagementSystem/staffList"><button class="btn mt-3" style="color: white; background-color: orange;">Get List</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
