<%-- 
    Document   : hostel
    Created on : 25 May 2023, 10:32:29 PM
    Author     : wongh
--%>
                        ...
                        <div class="row" style="background-color:white; color:black;">
                            <div class="col-md-12">
                                <div class="section-header text-center pb-5">
                                    <br><br>
                                    <h1 style="font-family: 'Rowdies'; color: black;">HOSTEL</h1>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">Add</h3>
                                            ...
                                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Add a New Hostel<br><span style="color:red; font-weight: 420;">*Only Admin is Allowed to Add</span><br><br>
                                            <a href="http://localhost:8080/UMTHostelManagementSystem/newHostel"><button class="btn mt-3" style="color: white; background-color: orange;" disabled="true">Add</button></a>
                                            <%} else { %>
                                            <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Add a New Hostel<br><br><br>
                                            <a href="http://localhost:8080/UMTHostelManagementSystem/newHostel"><button class="btn mt-3" style="color: white; background-color: orange;" >Add</button></a>
                                            <%}%>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Edit an Existing Hostel<br><br><br>
                                            <a href="http://localhost:8080/UMTHostelManagementSystem/hostelList"><button class="btn mt-3" style="color: white; background-color: orange;">Edit</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-12 col-lg-4">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <p class="lead" style="font-family: 'NTR', sans-serif;"><br>Get the List of Hostel<br><br><br>
                                            <a href="http://localhost:8080/UMTHostelManagementSystem/hostelList"><button class="btn mt-3" style="color: white; background-color: orange;">Get List</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
