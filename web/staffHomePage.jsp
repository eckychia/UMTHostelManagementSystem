<%-- 
    Document   : staffHome
    Created on : Jun 4, 2023, 4:58:56 PM
    Author     : admin
--%>
                    ...
                    <div class="row" style="background-color:white; color:black;">
                        <div class="col-md-12">
                            <div class="section-header text-center pb-5">
                                <br><br>
                                <%if (session.getAttribute("user").equals("admin")) { %>
                                <h1 style="font-family: 'Rowdies'; color: black;">ADMIN DASHBOARD</h1>
                                <%}else{%>
                                <h1 style="font-family: 'Rowdies'; color: black;">STAFF DASHBOARD</h1>
                                <%}%>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <a href="staffStaffPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    <div class="img-area mb-4">
                                        <br><br><img src="images/student.png" style="width:154px; height:154px;">
                                    </div><br>
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">STUDENT</h3><br>
                                        <a href="staffStudentPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>                        
                        <div class="col-12 col-md-12 col-lg-2">
                            ...
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">MERIT</h3><br>
                                        <a href="staffMeritPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">HOSTEL</h3><br>
                                        <a href="staffHostelPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">ROOM</h3><br>
                                        <a href="staffRoomPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <a href="staffApplicationPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="card text-center bg-white pb-2">
                                <div class="card-body text-dark">
                                    ...
                                    <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">REPORT</h3><br>
                                        <a href="staffReportPage.jsp"><button class="btn mt-3" style="color: white; background-color: orange;">Details</button></a>
                                </div><br>
                            </div>
                        </div>                        
                        <div class="col-12 col-md-12 col-lg-2">
