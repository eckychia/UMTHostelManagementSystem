<%-- 
    ...
    Created on : May 22, 2023, 3:12:21 PM
    Author     : admin
--%>
            ...
            <div class="hero" style="background:white;">
                ...
                <nav class="navbar2">
                    ...
                    <ul>
                        ...
                        <a href="studentList" class="btn1">Back</a>
                    </ul>
                </nav>
                        ...
                        <div class="card-body">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" value="<c:out value='${student.course}' />"
                                       class="form-control" name="course" required="required">
                            </fieldset>
                           ...
                           <fieldset class="form-group">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" value="<c:out value='${student.password}' />"
